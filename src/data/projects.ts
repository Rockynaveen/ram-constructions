...
export const projectsData: Project[] = [
  {
    ...
    featured: true,
    clientTestimonial: {
      quote: 'Atelier Vera approached our residence not merely as contractors, but as master craftsmen and design custodians. Every junction, concrete line, and custom timber element was executed to millimeter precision.',
  ...
  {
    id: 'atelier-hq-commercial',
    slug: 'apex-creative-headquarters',
    title: 'Apex Creative Headquarters',
    tagline: 'Bespoke corporate architecture emphasizing concrete elegance and open light wells.',
    category: 'Commercial',
    location: 'HITEC City, Hyderabad',
    year: '2024',
    area: '18,500 sq.ft',
    duration: '20 Months',
    budgetRange: '₹9.5 Cr - ₹11.0 Cr',
    ...
    gallery: [
      {
        ...
        caption: 'Parametric concrete facade providing passive shading to open-plan studio floors.',
        aspectRatio: 'wide'
      }
    ],
    overview: 'A five-story landmark commercial building tailored for a high-growth tech design studio, combining post-tensioned spans with natural plant atrium.',
    architecturalConcept: 'Productivity through natural illumination, collaborative garden balconies, and durable, maintenance-free materials.',
    spatialFeatures: [
      'Triple-height arrival atrium with preserved indoor ficus tree',
      'Acoustically isolated boardrooms with switchable smart glass',
      'Rooftop wellness studio and solar terrace'
    ],
    materials: [
      { name: 'Self-Compacting Architectural Concrete', description: 'Flawless raw architectural finish without plastering.' },
      { name: 'Electrochromic Smart Glass', description: 'Dynamic tinting for solar heat control.' }
    ],
    specifications: [
      { label: 'Green Rating', value: 'LEED Platinum Target Standard' }
    ],
    featured: false
  },
  {
  ...
  },
  {
    ...
    title: 'The Horizon Sky Villa',
    tagline: 'A hilltop architectural monument featuring 360-degree panoramic glass views.',
    category: 'Residential',
    location: 'Kokapet Golden Mile, Hyderabad',
    year: '2025',
    area: '13,500 sq.ft',
    duration: '22 Months',
    budgetRange: '₹7.5 Cr - ₹8.6 Cr',
    ...
    overview: 'A flagship three-story luxury villa constructed on a steep gradient with reinforced earth retention, suspended private spa deck, and 6-car subterranean showroom garage.',
    architecturalConcept: 'Stepped terraces conforming directly to topography to create layered privacy and grand entertaining stages.',
    spatialFeatures: [
      'Full glass cantilever lounge extending 4.5 meters past the structural edge',
      'Private glass pneumatic passenger elevator servicing all three levels',
      'Automated climate-controlled underground collector garage'
    ],
    materials: [
      { name: 'Pietra Grey Marble', description: 'Custom 2400x1200mm slabs with honed matte finish.' },
      { name: 'Titanium Zinc Cladding', description: 'Weatherproof standing seam facade panels.' }
    ],
    specifications: [
      { label: 'Foundation', value: 'Deep Bored Rock Socketed RCC Piles' },
      { label: 'Smart Infrastructure', value: 'Crestron Home Automation with biometric access' }
    ],
    featured: true
  }
];
