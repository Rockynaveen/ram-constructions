...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0B2545] border-t border-[#133E70] text-slate-300 font-sans relative overflow-hidden">
      ...
      {/* Top CTA Banner */}
      <div className="relative border-b border-white/10 py-10 bg-gradient-to-b from-[#0A192F] to-[#0B2545]">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            <div className="max-w-2xl">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-white font-normal leading-[1.15]">
                Have a residence or landmark in mind? <span className="italic text-[#38BDF8]">Let’s talk.</span>
              </h2>
              <p className="mt-3 text-sm font-normal text-slate-300 max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm font-light">
              ...
              <li>
                <Link to="/about" className="hover:text-white transition-colors">About & Lineage</Link>
              </li>
              <li>
                <Link to="/services" className="hover:text-white transition-colors">Core Disciplines</Link>
              </li>
              <li>
                <Link to="/projects" className="hover:text-white transition-colors">Selected Portfolio</Link>
              </li>
              <li>
                <Link to="/insights" className="hover:text-white transition-colors">Engineering Insights</Link>
              </li>
              <li>
